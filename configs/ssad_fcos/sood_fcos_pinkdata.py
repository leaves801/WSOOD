...
data_root = 'data/split_ss_pinkData/'
classes = ('pink',)
...
data = dict(
    ...
    train=dict(
        sup=dict(
            ann_file=data_root + 'train_labeled/annfiles/',
            img_prefix=data_root + 'train_labeled/images/',
            classes=classes,
        ),
        unsup=dict(
            ann_file=data_root + 'train_unlabeled/empty_annfiles/',
            img_prefix=data_root + 'train_unlabeled/images/',
            classes=classes,
        ),
    ),
    sampler=dict(
